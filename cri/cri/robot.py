...
class SyncRobot(Robot):
    ...
    def move_linear_step(self,pose,elbow=None):
        target_base_pose_q = pose
        self.controller.move_linear_step(target_base_pose_q, elbow)
...
class AsyncRobot(Robot):
    ...
    #===========function for unity==================
    def move_linear_unity(self,pose,elbow=None):
        check_pose(pose)
        target_base_pose_q = inv_transform(euler2quat(pose, self.sync_robot._axes), self.sync_robot._coord_frame_q)
        return target_base_pose_q

    def control_gripper(self,gripper):
        self.sync_robot.controller.control_gripper(gripper)
    
    def close_Pump(self):
        self.sync_robot.controller.control_pump(False)

    def move_linear_step(self,pose,elbow=None):
        self.sync_robot.move_linear_step(pose,elbow)

    def move_linear_stop(self):
        self.sync_robot.controller.move_linear_stop()
    def move_linear_forward(self):
        self.sync_robot.controller.move_linear_forward()
    def move_linear_back(self):
        self.sync_robot.controller.move_linear_back()
    def move_linear_left(self):
        self.sync_robot.controller.move_linear_left()
    def move_linear_right(self):
        self.sync_robot.controller.move_linear_right()
    def move_linear_up(self):
        self.sync_robot.controller.move_linear_up()
    def move_linear_down(self):
        self.sync_robot.controller.move_linear_down()
    def move_linear_speed(self,x,y,z):
        self.sync_robot.controller.move_linear_speed(x,y,z)

    def move_cont(self,x,y,z,i):
        self.sync_robot.controller._client.move_cont(x,y,z,i)
    #===============================================
